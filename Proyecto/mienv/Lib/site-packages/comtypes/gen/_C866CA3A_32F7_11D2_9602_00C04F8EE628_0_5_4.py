...
__all__ = [
    'IInternetSecurityManager', 'DISPID_SLRemovePronunciation',
    'SP_VISEME_19', 'SPEI_PHONEME', 'SVEVoiceChange',
    'DISPID_SOTGetAttribute', 'SpeechPartOfSpeech',
    'DISPID_SGRSTWeight', 'DISPID_SPRuleEngineConfidence',
    'SRADynamic', 'DISPID_SRGDictationLoad', 'SAFT22kHz16BitMono',
    'SpeechAudioVolume', 'DISPID_SABIEventBias', 'DISPID_SVResume',
    'SGRSTTTextBuffer', 'SVP_3', 'DISPID_SPERequiredConfidence',
    'DISPID_SGRSTsCount', 'SSFMCreateForWrite',
    'SpeechRecoContextState', 'eLEXTYPE_PRIVATE2',
    'DISPID_SDKEnumKeys', 'SpeechRetainedAudioOptions',
    'DISPID_SpeechVoiceEvent', 'DISPID_SDKSetLongValue',
    'SP_VISEME_14', 'SAFT48kHz8BitMono', 'SWTDeleted',
    ...
    'SP_VISEME_13', 'SpeechRecognitionType',
    'DISPID_SpeechPhraseBuilder', 'SpFileStream',
    'SAFT22kHz8BitStereo', 'SAFT48kHz16BitMono', 'eLEXTYPE_PRIVATE6',
    'SRESoundStart', 'SRTEmulated', 'DISPID_SRCEPropertyNumberChange',
    'SAFTGSM610_11kHzMono', 'DISPID_SpeechPhoneConverter',
    'DISPID_SPRulesCount', 'DISPID_SPEEngineConfidence', 'SVP_19',
    'ISpeechRecoContext', 'SPXMLRESULTOPTIONS',
    'SRSInactiveWithPurge', 'SPEVENT', 'DISPID_SVESentenceBoundary',
    'SPEVENTSOURCEINFO', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'ISpStreamFormatConverter', 'SRTAutopause',
    'DISPID_SRCEPhraseStart', 'DISPID_SRCERecognizerStateChange',
    '_ISpeechVoiceEvents', 'DISPID_SPERetainedSizeBytes',
    'SSTTDictation', 'SPDATAKEYLOCATION',
    'DISPID_SRSetPropertyString', 'SP_VISEME_7', 'SECHighConfidence',
    'ISpNotifySource', 'SPPS_RESERVED4', 'DISPID_SFSClose',
    'SGRSTTWildcard', 'DISPID_SVEStreamStart',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SOTsCount',
    'STCInprocHandler', 'DISPID_SRIsUISupported',
    'SPFM_OPEN_READWRITE', 'ISpeechAudioFormat',
    ...
    'ISpSerializeState', 'SASStop', 'SVSFNLPMask',
    'SPDKL_CurrentUser', 'DISPID_SRSSupportedLanguages',
    'SGRSTTDictation', 'DISPID_SOTGetStorageFileName', 'SFTSREngine',
    'DISPID_SWFEChannels', 'DISPID_SVGetAudioInputs', 'SPWORDTYPE',
    'SAFT16kHz8BitMono', 'ISpeechRecognizer', 'DISPID_SRCResume',
    'DISPID_SVEPhoneme', 'DISPID_SRCEHypothesis',
    'DISPID_SpeechPhraseElements', 'DISPID_SVSInputSentenceLength',
    'ISpObjectToken', 'DISPID_SGRAddState', 'SP_VISEME_1',
    'ISpNotifySink', 'SREPrivate', 'DISPID_SRStatus', 'SPRST_ACTIVE',
    'DISPID_SWFEAvgBytesPerSec', 'SPWT_LEXICAL', 'ISpPhrase',
    'DISPID_SpeechLexiconPronunciation', 'SPAS_CLOSED', 'SPPS_Verb',
    'DISPID_SGRsFindRule', 'SpeechPropertyHighConfidenceThreshold',
    'SPCT_COMMAND', 'SAFTADPCM_22kHzMono', 'SRTStandard',
    'DISPID_SVEEnginePrivate', 'eWORDTYPE_DELETED',
    'SPINTERFERENCE_TOOSLOW', 'STCLocalServer', 'DISPID_SOTs_NewEnum',
    'SAFT11kHz8BitMono', 'SPEI_MIN_TTS', 'DISPID_SOTCGetDataKey',
    'DISPID_SpeechPhraseAlternates', 'ISpeechObjectToken',
    'SpNullPhoneConverter', 'SpeechAudioProperties', 'SVP_4',
    'DISPID_SWFEBlockAlign', 'SpeechAudioFormatGUIDWave',
    'DISPID_SBSSeek', 'DISPID_SOTIsUISupported',
    'IInternetSecurityMgrSite', 'ISpRecognizer2',
    'SPRST_INACTIVE_WITH_PURGE', 'SPEI_RESERVED6',
    'DISPID_SMSAMMHandle', 'DISPID_SBSRead', 'ISpeechPhraseRules',
    'DISPID_SPIReplacements', 'DISPID_SpeechPhraseRules',
    ...
    'SRAExport', 'SPPS_Modifier', 'DISPID_SVGetVoices',
    'STSF_AppData', 'SpPhoneConverter', 'SPPARTOFSPEECH',
    'ISpeechTextSelectionInformation', 'SPSERIALIZEDPHRASE',
    'DISPID_SPIAudioStreamPosition', 'ISpEventSink',
    'DISPID_SpeechCustomStream', 'SPAUDIOOPTIONS', 'SVP_6',
    'DISPID_SDKSetBinaryValue', 'DISPID_SpeechVoice', 'tagSTATSTG',
    'SPSTREAMFORMATTYPE', 'SPWF_SRENGINE', 'DISPID_SOTCDefault',
    'DISPID_SVStatus', 'SDA_No_Trailing_Space', 'SpInProcRecoContext',
    'ISpeechVoiceStatus', 'SPWORDPRONUNCIATION',
    'SAFTCCITT_uLaw_22kHzStereo', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SPPConfidence', 'eLEXTYPE_RESERVED8',
    'SPEI_RECO_STATE_CHANGE', 'eLEXTYPE_PRIVATE1', 'DISPID_SRRAudio',
    'DISPID_SPEAudioStreamOffset', 'SpeechDictationTopicSpelling',
    'DISPID_SVSpeakStream', 'DISPID_SVEventInterests',
    'DISPID_SLWPronunciations', 'SPEI_SR_BOOKMARK',
    'SpeechPropertyResponseSpeed', 'DISPID_SRCERequestUI',
    'DISPID_SPIAudioSizeBytes', 'SAFT44kHz16BitMono',
    'DISPID_SPRuleConfidence', 'SPEI_TTS_PRIVATE',
    'ISpeechPhraseAlternates', 'SAFTDefault',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SGRClear', 'ISpShortcut',
    'DISPID_SPPEngineConfidence', 'DISPID_SREmulateRecognition',
    'SAFTCCITT_ALaw_44kHzMono', 'SRERecoOtherContext', 'SPAS_RUN',
    'DISPID_SVSLastBookmarkId', 'DISPID_SRCEFalseRecognition',
    'SpMMAudioEnum', 'SECNormalConfidence',
    'DISPID_SDKSetStringValue', 'DISPID_SASetState',
    'DISPID_SPEDisplayAttributes', 'ISpXMLRecoResult',
    'SAFTADPCM_11kHzStereo', 'SRCS_Disabled', 'DISPID_SpeechLexicon',
    'DISPID_SLGetPronunciations', 'SpMemoryStream', 'DISPID_SPIRule',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SDKDeleteValue',
    'SPVPRI_NORMAL', 'DISPID_SLGenerationId', 'SP_VISEME_11',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SWFEFormatTag',
    'DISPID_SOTGetDescription', 'SLODynamic', 'SAFT32kHz8BitMono',
    'SVP_0', 'SPSHT_EMAIL', 'SECFIgnoreWidth', 'ISpRecoCategory',
    'SVP_20', 'DISPID_SDKEnumValues', 'SpeechGrammarTagWildcard',
    'SpNotifyTranslator', 'SPWT_DISPLAY', 'SPINTERFERENCE_NOSIGNAL',
    ...
    'SpeechTokenKeyFiles', 'DISPID_SVPriority',
    'SpeechCategoryPhoneConverters', 'SLTApp', 'DISPID_SGRsAdd',
    'DISPID_SVIsUISupported', 'DISPID_SRCPause', 'ISpeechPhraseInfo',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SVSPhonemeId', 'SPPROPERTYINFO',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SPRsCount',
    'ISpStreamFormat', 'DISPID_SRGetPropertyNumber',
    'DISPID_SpeechDataKey', 'DISPID_SASFreeBufferSpace',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SpAudioFormat',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SpeechRecoResult2',
    'SPSFunction', 'SPFILEMODE', 'SPCT_SUB_DICTATION',
    'ISpRecoContext', 'SPBINARYGRAMMAR', 'STCRemoteServer',
    'DISPID_SOTRemoveStorageFileName', 'SpeechSpecialTransitionType',
    'SPCS_DISABLED', 'DISPID_SOTRemove', 'DISPID_SVSRunningState',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SRRAudioFormat',
    'DISPID_SPEPronunciation', 'DISPID_SLGetGenerationChange',
    'DISPID_SPEActualConfidence', 'DISPID_SGRSTPropertyValue',
    'SPEI_START_SR_STREAM', 'SECLowConfidence', 'DISPID_SPEsCount',
    'SINoSignal', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SPCLangId', 'DISPID_SLPSymbolic', 'SPRULE', 'SpVoice',
    'SPAR_Unknown', 'SVP_9', 'SRAInterpreter', 'SAFT32kHz8BitStereo',
    'SPEI_SR_RETAINEDAUDIO', 'SPCS_ENABLED', 'DISPID_SGRInitialState',
    'eLEXTYPE_PRIVATE3', 'SpeechRecoEvents', 'SPBO_PAUSE',
    'SpeechTokenIdUserLexicon', 'DISPID_SPELexicalForm',
    'SPINTERFERENCE_NOISE', 'SVSFPersistXML', 'ISpRecognizer',
    'ISpeechPhraseReplacement', 'SVPOver',
    'SpeechRecoProfileProperties', 'DISPID_SpeechObjectToken',
    'SAFTCCITT_uLaw_44kHzMono', 'SpeechRegistryLocalMachineRoot',
    'SPPS_Unknown', 'SPFM_OPEN_READONLY', 'SpResourceManager',
    'SpLexicon', 'DISPID_SpeechPhraseInfo', 'SSTTTextBuffer',
    'SpWaveFormatEx', 'DISPID_SpeechMMSysAudio',
    'DISPID_SDKGetlongValue', 'SAFTGSM610_22kHzMono', 'SDTAudio',
    ...
    'eLEXTYPE_MORPHOLOGY', 'SP_VISEME_3', 'SREInterference',
    'ISpeechLexiconWord', 'SDTProperty', 'eLEXTYPE_PRIVATE17',
    'DISPID_SASNonBlockingIO', 'DISPID_SDKOpenKey',
    'DISPID_SADefaultFormat', 'SVEWordBoundary',
    'DISPID_SPIGrammarId', 'ISpRecoContext2', 'DISPID_SAEventHandle',
    'SAFTADPCM_44kHzMono', 'SDA_Consume_Leading_Spaces', 'SPAO_NONE',
    'SPPS_Interjection', 'DISPID_SMSSetData', 'DISPID_SVGetProfiles',
    'SpCompressedLexicon', 'SPWT_PRONUNCIATION', 'SREAdaptation',
    'SpSharedRecognizer', 'DISPID_SPPsItem', 'ISpeechPhraseRule',
    'DISPID_SVSkip', 'DISPID_SRGSetTextSelection',
    'SpeechCategoryRecognizers', 'SPEI_WORD_BOUNDARY',
    'DISPID_SRSClsidEngine', 'ISpMMSysAudio', 'DISPID_SAFGuid',
    'SpeechVoiceEvents', 'SPEI_SOUND_START', 'SPAUDIOSTATUS',
    'SVEViseme', 'DISPID_SRGCmdLoadFromObject', 'DISPID_SPACommit',
    'DISPID_SPRuleId', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SGPronounciation', 'SREStreamEnd', 'SINoise',
    'DISPID_SPRulesItem', 'tagSPTEXTSELECTIONINFO',
    'SpeechBookmarkOptions', 'SPDKL_DefaultLocation', 'ISpStream',
    'ISpLexicon', 'DISPID_SRCEAudioLevel',
    'DISPID_SVSCurrentStreamNumber',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SLWType',
    'SRADefaultToActive', 'Speech_Max_Pron_Length',
    'SAFT44kHz8BitStereo', 'SAFTADPCM_22kHzStereo',
    'DISPID_SRDisplayUI', 'DISPID_SWFESamplesPerSec',
    'SPCT_DICTATION', 'SPRECOCONTEXTSTATUS', 'SpPhraseInfoBuilder',
    'SpeechRuleAttributes', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'ISpeechXMLRecoResult', 'DISPID_SpeechMemoryStream',
    'SVEEndInputStream', 'DISPID_SAFType', 'ISpeechRecognizerStatus',
    'ISpVoice', 'DISPID_SGRs_NewEnum', 'DISPID_SLGetWords',
    'DISPID_SGRSTRule', 'SWPKnownWordPronounceable', 'ISpRecoGrammar',
    'DISPID_SRRRecoContext', 'SPVPRIORITY', 'SPEI_PHRASE_START',
    '__MIDL_IWinTypes_0009', 'SPPHRASEPROPERTY', 'SGRSTTRule',
    'SpeechFormatType', 'SGDSActiveWithAutoPause',
    'DISPID_SLPs_NewEnum', 'DISPID_SPPsCount', 'SLTUser',
    ...
    'DISPID_SPPValue', 'DISPID_SPRFirstElement', 'DISPID_SAStatus',
    'WAVEFORMATEX', 'eLEXTYPE_PRIVATE11', 'DISPID_SRAudioInput',
    'SWPUnknownWordPronounceable', 'SPLOADOPTIONS',
    'DISPID_SRCRecognizer', 'SPBOOKMARKOPTIONS', 'DISPID_SLWWord',
    'SASClosed', 'ISpeechPhraseProperty', 'SPSNoun',
    'SpeechCategoryVoices', 'DISPID_SRSCurrentStreamNumber',
    'SPEI_SR_PRIVATE', 'SpMMAudioIn', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SPAs_NewEnum',
    'SITooSlow', 'SAFT12kHz16BitMono', 'SAFT11kHz16BitMono',
    'DISPID_SGRsItem', 'SRAImport', 'SPADAPTATIONRELEVANCE',
    'SP_VISEME_15', 'SAFT12kHz16BitStereo', 'SVEPrivate',
    'SpeechAudioState', 'SVEAudioLevel', 'SP_VISEME_5', 'SVP_5',
    'IEnumString', 'SPSHT_OTHER', 'DISPID_SDKCreateKey',
    'SSSPTRelativeToStart', 'DISPID_SBSFormat', 'SAFT8kHz16BitMono',
    'DISPID_SPRNumberOfElements', 'SPPS_NotOverriden',
    'SPEI_RESERVED3', 'SPAUDIOSTATE', 'SPINTERFERENCE_TOOFAST',
    'ISpEventSource', 'ISpeechMMSysAudio', 'SVSFlagsAsync',
    'DISPID_SOTDisplayUI', 'DISPID_SVSLastBookmark', 'SRSActive',
    'DISPID_SMSGetData', 'DISPID_SOTMatchesAttributes',
    'SPRST_INACTIVE', 'SAFTGSM610_44kHzMono',
    'DISPID_SRGCmdSetRuleState', 'SPEI_MAX_TTS',
    'DISPID_SRCRetainedAudio', 'SpeechStreamFileMode',
    'DISPID_SpeechGrammarRuleState', 'SGSExclusive',
    'SDKLLocalMachine', 'SpeechAudioFormatGUIDText', 'SP_VISEME_2',
    'DISPID_SRGetFormat', 'SpeechCategoryAudioOut',
    'SpeechMicTraining', 'SVP_14', 'SPWORD',
    'DISPID_SRCEEnginePrivate', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SVVoice', 'DISPID_SGRId', 'DISPID_SpeechPhraseRule',
    'ISpRecognizer3', 'DISPID_SRCreateRecoContext', 'SVP_12',
    'SPFM_CREATE', 'SpeechCategoryAppLexicons', 'SP_VISEME_17',
    'DISPID_SPPName', 'eLEXTYPE_APP', 'SAFTText', 'SP_VISEME_16',
    'SPSEMANTICFORMAT', 'DISPID_SGRSTType', 'DISPID_SPAPhraseInfo',
    'SPDKL_LocalMachine', 'SVP_21', 'DISPID_SRGReset',
    'DISPID_SRGDictationSetState', 'SVF_None', 'DISPID_SCSBaseStream',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SOTCSetId', 'SVP_1',
    'SPSMF_UPS', 'DISPID_SOTsItem', 'SpPhoneticAlphabetConverter',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SRGCmdLoadFromFile',
    'SREBookmark', 'SPEI_SENTENCE_BOUNDARY', 'DISPID_SPRsItem',
    'DISPID_SGRSTsItem', 'SAFT8kHz8BitStereo', 'SPEI_RESERVED1',
    'DISPID_SGRsCount', 'SRARoot', 'DISPID_SRGRules',
    'DISPID_SRGIsPronounceable', 'SPRS_ACTIVE', 'DISPID_SPIElements',
    'DISPID_SRGId', 'eLEXTYPE_PRIVATE8', 'DISPID_SFSOpen', 'SPAR_Low',
    'SGRSTTWord', 'ISpeechCustomStream', 'DISPID_SLPPartOfSpeech',
    ...
    'DISPID_SVSVisemeId', 'SPEI_RESERVED5', 'DISPID_SRCCreateGrammar',
    'DISPID_SRCRetainedAudioFormat', 'SpObjectToken', 'SPSModifier',
    'SAFT22kHz8BitMono', 'DISPID_SGRSTs_NewEnum', 'SGDSInactive',
    'DISPID_SPPs_NewEnum', 'SRSEDone', 'DISPID_SpeechVoiceStatus',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SPRules_NewEnum',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SPPFirstElement',
    'DISPID_SRCEAdaptation', 'SRERecognition', 'SAFT48kHz16BitStereo',
    'SPPS_RESERVED3', 'DISPID_SLPPhoneIds', 'SpeechEngineConfidence',
    'ISpeechRecoResultTimes', 'SpShortcut', 'SVP_8', 'SECFIgnoreCase',
    'ISpeechGrammarRuleState', 'DISPID_SPRuleChildren',
    'SRSEIsSpeaking', 'DISPID_SPRuleName', 'SPWORDPRONUNCIATIONLIST',
    'DISPIDSPTSI_ActiveLength', 'SpeechStreamSeekPositionType',
    'DISPID_SRCESoundStart', 'DISPID_SRCESoundEnd',
    'SAFT11kHz16BitStereo', 'SPSLMA', 'SpeechAudioFormatType',
    'SDTPronunciation', 'SVSFParseSsml', 'eLEXTYPE_PRIVATE4',
    'SPGS_ENABLED', 'SAFT44kHz16BitStereo',
    'ISpeechPhraseInfoBuilder', 'SpeechVoicePriority',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SPCIdToPhone',
    'SpeechPropertyResourceUsage',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SGRAttributes',
    'SPRECOGNIZERSTATUS', 'SP_VISEME_0', 'SPBO_AHEAD',
    'SDTReplacement', 'SRAONone', 'DISPID_SPIEnginePrivateData',
    'SPAO_RETAIN_AUDIO', 'DISPID_SVSInputWordLength',
    'SAFT22kHz16BitStereo', 'DISPID_SASCurrentDevicePosition',
    'SpSharedRecoContext', 'SPRECORESULTTIMES',
    'DISPID_SRRGetXMLErrorInfo', 'SPEI_END_INPUT_STREAM',
    'SREAllEvents', 'SVF_Stressed', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SOTId', 'DISPID_SpeechWaveFormatEx',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SRProfile',
    'SPAR_Medium', 'DISPID_SGRSTPropertyId', 'SAFT24kHz8BitStereo',
    'STCInprocServer', 'ISpDataKey', 'eLEXTYPE_LETTERTOSOUND',
    'SVSFParseAutodetect', 'DISPID_SpeechRecoContext',
    'SSFMOpenReadWrite', 'DISPID_SOTCreateInstance',
    'SPAUDIOBUFFERINFO', 'SGDSActive', 'DISPID_SpeechFileStream',
    'DISPID_SpeechAudioBufferInfo', 'DISPIDSPTSI',
    'DISPID_SVEVoiceChange', 'SpeechEngineProperties',
    'ISpeechAudioStatus', 'DISPID_SRRAlternates', 'SPSVerb',
    'DISPID_SAFSetWaveFormatEx', 'ISpPhoneticAlphabetSelection',
    'SECFIgnoreKanaType', 'ISpeechWaveFormatEx', 'ISpPhraseAlt',
    'SPSHORTCUTPAIR', 'SREAudioLevel', 'ISpeechAudio', 'SVPAlert',
    'SPEI_END_SR_STREAM', 'SPFM_NUM_MODES', 'SPDKL_CurrentConfig',
    'DISPID_SVEViseme', 'SREStateChange', 'SVP_18', 'SP_VISEME_20',
    'DISPID_SRGDictationUnload', 'SVSFNLPSpeakPunc',
    'DISPID_SLPLangId', 'DISPID_SRCVoice', 'SAFTCCITT_ALaw_8kHzMono',
    'SRCS_Enabled', 'SpeechRegistryUserRoot',
    'DISPID_SPRDisplayAttributes', 'SP_VISEME_21',
    'DISPID_SpeechRecognizerStatus',
    'DISPID_SpeechObjectTokenCategory', 'SPCATEGORYTYPE',
    'SAFTNonStandardFormat', 'DISPID_SRCBookmark',
    'SPEI_TTS_BOOKMARK', 'SWPUnknownWordUnpronounceable',
    'ISpeechMemoryStream', 'DISPID_SMSALineId', 'SITooLoud',
    'SAFTNoAssignedFormat', 'SPRS_ACTIVE_USER_DELIMITED',
    'SPRECOSTATE', 'DISPID_SRRTimes', 'SRESoundEnd', 'SREPhraseStart',
    'SPEI_SR_AUDIO_LEVEL', 'SGLexical', 'SpeechCategoryRecoProfiles',
    'SPPS_Noncontent', 'DISPID_SRRTLength', 'DISPID_SRCEInterference',
    'SpeechRecognizerState', 'DISPID_SGRsCommit', 'SVP_10',
    'SDTLexicalForm', 'DISPID_SRCVoicePurgeEvent',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'ISpeechAudioBufferInfo',
    'SRSActiveAlways', 'SDKLCurrentUser', 'STSF_FlagCreate',
    'DISPID_SpeechPhraseElement', 'SDTAlternates', 'SpeechWordType',
    'SGDSActiveUserDelimited', 'SSFMOpenForRead',
    'ISpeechPhraseAlternate', 'SpeechGrammarTagDictation',
    'SRAORetainAudio', 'DISPID_SLPsCount',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SVSyncronousSpeakTimeout',
    'SpeechPropertyLowConfidenceThreshold',
    'SAFTCCITT_uLaw_44kHzStereo', 'SVP_7', 'SPWF_INPUT',
    'DISPID_SPPNumberOfElements', 'DISPID_SLAddPronunciation',
    'SPSSuppressWord', 'SPSHT_Unknown', 'DISPID_SVSLastResult',
    'SpeechTokenKeyAttributes', 'DISPID_SPAsItem',
    'DISPID_SPIGetText', 'DISPID_SpeechLexiconWord',
    'SPSEMANTICERRORINFO', 'SPEI_VISEME', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'DISPID_SBSWrite',
    'SAFT12kHz8BitMono', 'ISpObjectWithToken', 'ISpRecoGrammar2',
    'SSSPTRelativeToEnd', 'DISPID_SWFEBitsPerSample',
    'SpeechRuleState', 'SpeechCategoryAudioIn', 'SAFT24kHz16BitMono',
    'SAFT44kHz8BitMono', 'SAFTCCITT_uLaw_8kHzStereo',
    'eLEXTYPE_RESERVED10', 'DISPID_SPPParent', 'SAFT8kHz16BitStereo',
    'ISpeechPhraseElements', 'SPWAVEFORMATTYPE',
    'SpStreamFormatConverter', 'ISpeechGrammarRule', 'DISPID_SVEWord',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPVOICESTATUS',
    'SPGS_DISABLED', 'ISpeechVoice', 'STSF_LocalAppData',
    'SpeechUserTraining', 'IStream', 'DISPID_SpeechAudioFormat',
    'DISPID_SRCEBookmark', 'SpeechTokenValueCLSID',
    'DISPID_SDKDeleteKey', 'ISpAudio', 'SAFT48kHz8BitStereo',
    'eLEXTYPE_PRIVATE20', 'SAFTADPCM_8kHzStereo', 'DISPID_SGRName',
    'DISPID_SABIBufferSize', 'DISPID_SRRTTickCount',
    'DISPID_SRCEventInterests', 'SSFMCreate', 'DISPID_SRCEEndStream',
    'DISPID_SOTCId', 'SPEI_HYPOTHESIS', 'SAFTADPCM_11kHzMono',
    'ISpeechRecoResultDispatch', '_RemotableHandle', 'SRERequestUI',
    'SpeechAllElements', 'SPEI_ADAPTATION', 'SpInprocRecognizer',
    'ISpeechLexiconPronunciation',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SpeechLexiconProns', 'DISPID_SGRSTransitions',
    'SPPHRASEREPLACEMENT', 'SPEI_TTS_AUDIO_LEVEL', 'STCAll',
    'SRTExtendableParse', 'DISPID_SPISaveToMemory', 'DISPID_SRCState',
    'SPGRAMMARWORDTYPE', 'DISPID_SPEs_NewEnum', 'DISPID_SABufferInfo',
    'SPRST_NUM_STATES', 'SpeechDiscardType', 'eLEXTYPE_PRIVATE19',
    'Speech_StreamPos_Asap', 'eLEXTYPE_VENDORLEXICON',
    'SPSInterjection', 'DISPID_SpeechRecoResult', 'SP_VISEME_12',
    'SPSERIALIZEDRESULT', 'SDTDisplayText', 'DISPID_SVEStreamEnd',
    'SPCT_SUB_COMMAND', 'SVP_16',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SMSADeviceId',
    'SDKLDefaultLocation', 'SECFDefault', 'SVEStartInputStream',
    'SVESentenceBoundary', 'SPVPRI_ALERT', 'SPEI_MIN_SR',
    'SpeechAddRemoveWord', 'SDA_One_Trailing_Space',
    'ISpeechBaseStream', 'SpeechTokenShellFolder', 'SPXRO_SML',
    'SPLEXICONTYPE', '_SPAUDIOSTATE', 'SAFTTrueSpeech_8kHz1BitMono',
    'eLEXTYPE_PRIVATE10', 'DISPID_SpeechGrammarRule', 'SVEBookmark',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SVAlertBoundary', 'STSF_CommonAppData',
    'SREPropertyStringChange', 'SASPause', 'DISPID_SRGState',
    'SPSHORTCUTPAIRLIST', 'SRSInactive', 'eLEXTYPE_PRIVATE16',
    'SPEVENTENUM', 'SPLO_STATIC', 'DISPID_SRState',
    'DISPID_SWFEExtraData', 'SRATopLevel', 'DISPID_SGRSRule',
    'SpeechLexiconType', 'SPRS_INACTIVE', 'DISPID_SOTDataKey',
    'SpeechWordPronounceable', 'DISPID_SRRPhraseInfo',
    'DISPID_SRRGetXMLResult', 'DISPID_SPANumberOfElementsInResult',
    'SPPS_SuppressWord', 'eLEXTYPE_RESERVED6', 'SDKLCurrentConfig',
    'ISpeechRecoResult2', 'SAFTGSM610_8kHzMono',
    'SPTEXTSELECTIONINFO', 'ISpeechRecoGrammar',
    'SPINTERFERENCE_NONE', 'SINone', 'DISPID_SLWLangId',
    'SPPHRASERULE', 'SPEI_RECOGNITION', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SPIGetDisplayAttributes', 'SFTInput',
    'DISPID_SRRecognizer', 'ISpeechPhoneConverter',
    'DISPID_SLWsCount', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SGRSAddWordTransition', 'SPPS_Noun', 'SVPNormal',
    'SVSFUnusedFlags', 'DISPID_SOTCategory',
    'DISPID_SRCEPropertyStringChange', 'SAFT16kHz8BitStereo',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SRGRecoContext',
    'SVSFIsXML', 'eLEXTYPE_RESERVED9', 'SLOStatic', 'DISPID_SLPsItem',
    'SPVPRI_OVER', 'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPVISEMES', 'DISPID_SGRSAddSpecialTransition', 'DISPID_SVSpeak',
    'SREHypothesis', 'DISPID_SASState', 'eLEXTYPE_PRIVATE12',
    'SPGRAMMARSTATE', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SP_VISEME_8', 'SVSFParseMask',
    'ISpeechGrammarRuleStateTransitions', 'ISpGrammarBuilder',
    'DISPID_SPIAudioSizeTime', 'SPRULESTATE', 'SpeechTokenContext',
    'DISPID_SPIProperties', 'SpeechVoiceSpeakFlags', 'SVP_11',
    'DISPID_SPAStartElementInResult', 'SP_VISEME_4',
    'eLEXTYPE_RESERVED4', 'eLEXTYPE_PRIVATE7', 'SPLO_DYNAMIC',
    'SPWORDLIST', 'SPCONTEXTSTATE', 'SWTAdded', 'eLEXTYPE_PRIVATE18',
    'DISPID_SPEAudioTimeOffset',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPEI_RESERVED2',
    'SpMMAudioOut', 'SpeechLoadOption', 'SpObjectTokenCategory',
    'SPSUnknown', 'SpCustomStream', 'SGSEnabled',
    'DISPID_SVWaitUntilDone', 'ISpPhoneticAlphabetConverter',
    'SVSFPurgeBeforeSpeak', 'SPPHRASE', 'SP_VISEME_6', 'SVP_15',
    ...
    'SPSHORTCUTTYPE', 'DISPID_SPIStartTime', 'SITooQuiet',
    'SREFalseRecognition', 'SAFT32kHz16BitStereo',
    'DISPID_SRRSpeakAudio', 'SPEI_REQUEST_UI', 'DISPID_SPPId',
    'SVF_Emphasis', 'DISPID_SABIMinNotification', 'ISequentialStream',
    'DISPID_SRCSetAdaptationData', 'DISPID_SPAsCount',
    'DISPID_SGRAddResource', 'DISPIDSPRG',
    'SAFTCCITT_ALaw_11kHzStereo', 'SVSFIsNotXML', 'ISpeechDataKey',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SPEDisplayText',
    'eLEXTYPE_PRIVATE14', 'DISPID_SAVolume',
    'DISPID_SGRsCommitAndSave', 'DISPID_SPILanguageId',
    'ISpeechLexicon', 'DISPID_SGRsDynamic', 'DISPID_SPRs_NewEnum',
    'SpeechTokenKeyUI', 'ISpeechLexiconWords', 'DISPID_SVPause',
    'SPBO_NONE', 'SDA_Two_Trailing_Spaces',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SVVolume',
    'DISPID_SRRSaveToMemory', 'SVSFVoiceMask', 'LONG_PTR',
    'IEnumSpObjectTokens', 'SVP_13', 'SVSFIsFilename',
    'SpeechRunState', 'ISpNotifyTranslator', 'SPEI_VOICE_CHANGE',
    'SAFTADPCM_44kHzStereo', 'DISPID_SVRate', 'DISPID_SPRuleParent',
    'SVSFDefault', 'DISPID_SVEAudioLevel', 'ISpPhoneConverter',
    'DISPID_SDKGetStringValue', 'ISpResourceManager',
    'SAFTADPCM_8kHzMono', 'SPFM_CREATE_ALWAYS',
    'ISpeechPhraseProperties', 'DISPID_SRIsShared',
    'ISpeechResourceLoader', 'DISPID_SRSAudioStatus',
    'DISPID_SPEsItem', 'SBOPause', 'SDTRule', 'SPAS_PAUSE', 'SDTAll',
    'SPPS_RESERVED2', 'tagSPPROPERTYINFO',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SRAudioInputStream',
    'DISPID_SOTSetId', 'SAFT11kHz8BitStereo', 'SVEPhoneme',
    'DISPID_SRRSetTextFeedback', 'SVEAllEvents', 'SSTTWildcard',
    'SPINTERFERENCE', 'eLEXTYPE_PRIVATE15', 'eLEXTYPE_PRIVATE13',
    'SGRSTTEpsilon', 'SpeechEmulationCompareFlags',
    'DISPID_SpeechPhraseProperties', 'SITooFast', 'SASRun',
    'SpeechVisemeType', 'DISPID_SPPChildren', 'SPAR_High',
    'DISPIDSPTSI_SelectionOffset', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SPIRetainedSizeBytes', 'ISpeechObjectTokenCategory',
    'DISPID_SDKGetBinaryValue', 'SPPS_Function',
    'ISpeechLexiconPronunciations', 'SAFTCCITT_uLaw_11kHzStereo',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SGSDisabled', 'SVP_2',
    'SAFT16kHz16BitMono', 'ISpeechRecoResult', 'SVP_17',
    'eLEXTYPE_PRIVATE9', 'DISPID_SLPType', 'SPSHT_NotOverriden',
    'SpeechVisemeFeature', 'Speech_StreamPos_RealTime',
    '_ISpeechRecoContextEvents', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SpeechGrammarRules', 'eLEXTYPE_USER',
    'DISPID_SVSpeakCompleteEvent',
    'SpeechGrammarTagUnlimitedDictation', 'SPSNotOverriden',
    'eLEXTYPE_PRIVATE5', 'DISPID_SpeechLexiconWords', 'SPCT_SLEEP',
    'SGLexicalNoSpecialChars', 'DISPID_SVSInputSentencePosition',
    'DISPID_SRSetPropertyNumber', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SPRText', 'ISpeechGrammarRules', 'ISpeechFileStream',
    'DISPID_SVDisplayUI', 'SBONone', 'DISPID_SRCERecognition',
    'DISPID_SPIEngineId', 'SpeechGrammarWordType', 'SP_VISEME_18',
    'DISPID_SRGCommit', 'DISPID_SVEBookmark',
    'DISPID_SpeechPhraseReplacements',
    'DISPID_SVSLastStreamNumberQueued', 'SpeechGrammarState',
    'UINT_PTR', 'SRTSMLTimeout', 'DISPID_SpeechAudioStatus',
    'SPEI_SOUND_END', 'SAFT24kHz16BitStereo', 'DISPID_SRRTStreamTime',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SpeechBaseStream',
    'SpStream', 'SPEI_RECO_OTHER_CONTEXT', 'eWORDTYPE_ADDED',
    'DISPID_SpeechRecognizer', 'SPWORDPRONOUNCEABLE', 'SPAS_STOP',
    'ISpRecoResult', 'DISPID_SRGetRecognizers',
    'SpUnCompressedLexicon', 'Speech_Max_Word_Length', 'SPPS_LMA',
    'DISPID_SVGetAudioOutputs', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SRGCmdSetRuleIdState', 'ISpProperties',
    'SAFT12kHz8BitStereo', 'DISPID_SABufferNotifySize',
    'DISPID_SPARecoResult', 'SREPropertyNumChange', 'SPPHRASEELEMENT',
    'SpeechPropertyAdaptationOn', 'DISPID_SRGCmdLoadFromMemory',
    'SP_VISEME_9', 'SPGS_EXCLUSIVE', 'SPEI_MAX_SR',
    'DISPID_SVSInputWordPosition', 'SGDisplay', 'SECFEmulateResult',
    'ISpeechPhraseElement', 'SpTextSelectionInformation', 'SRTReSent',
    'SAFT32kHz16BitMono', 'SECFNoSpecialChars', 'SpeechInterference'
]

_check_version('1.2.0', 1619119157.922844)
